  ...
  <div class="secure-container">
    ...
    <section class="secure-section">
      ...
      <div class="secure-presentation" style="max-width:98vw; margin:0 auto;">
        <iframe src="/assets/pdfjs/web/viewer.html?file=/assets/GloZ-Fundraising-2026.pdf" width="98vw" height="1200" style="border-radius:14px; background:#fff; display:block; margin:0 auto;" frameborder="0"></iframe>
      </div>
    </section>
